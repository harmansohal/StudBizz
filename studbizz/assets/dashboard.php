...
{
 if(document.getElementById('organisation_name').value=="")
 {
...
<div class="form-group">
  ...
  <input  name="organisation_name" id="organisation_name"  placeholder="Organisation Name" class="form-control" type="text">
...
<div class="form-group">
  ...
  <input name="website" id="website" placeholder="Website name"  pattern="https?://.+" class="form-control" type="text">
    </div>
  </div>
</div>
<!-- Text input-->    	
  ...
  <label class="col-md-4 control-label">Logo</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-globe"></i></span>
  <input name="logo" id="logo"  placeholder="website Name" class="form-control" type="text">
    </div>
  </div>
</div>
